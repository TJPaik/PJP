...
class circular_coordinate():
    ...
    def minimize(self, Delta, cocycle, new_dist, weight=False):
        ...
        if weight:
            ...
            # new_dist_sqr = np.random.random(new_dist_sqr.shape) * np.random.random_integers(0, 2,new_dist_sqr.shape)
    ...
    def plot_eps(self, p1, vertex_values, vert_list=None, init_verts=None, dist_='l1', type='2d', **kwargs):
        ...
        if type == '2d':
            ...
            plot_eps(p1, vertex_values, type='multi', vert_list=vert_list,
                     dist=self.get_dist_all(init_verts, vertex_values, dist_), **twodkwargs)
    ...
    def plot_pca(self, data, vertex_values, **kwargs):
        ...
        """
        plot_kwargs = {'xlabel': 'Principal Component 1', 'ylabel': 'Principal Component 2', 'fig_size': (10, 10),
                       'ax': None, 'pt_style': None}
